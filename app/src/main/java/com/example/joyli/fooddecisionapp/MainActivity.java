...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void getListOfRestaurants(double latitude, double longitude, String category){
        ...
        getRequestBuilder.addQueryParameter("open_now", "true");
        String requestUrl = getRequestBuilder.build().toString();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()){
                    ...
                    try {
                        ...
                        restaurant1 = new Restaurant(businessesJsonArray.getJSONObject(0), getApplicationContext(), mRate, mRestaurantTitle, mLocation, mReview, mMainImage);
                        restaurant2 = new Restaurant(businessesJsonArray.getJSONObject(1), getApplicationContext(), mRate2, mRestaurantTitle2, mLocation2, mReview2, mMainImage2);
                        restaurant3 = new Restaurant(businessesJsonArray.getJSONObject(2), getApplicationContext(), mRate3, mRestaurantTitle3, mLocation3, mReview3, mMainImage3);
  ...
  private String chooseAFoodCategory(int randomNum){
    ...
    public void setAllProgressBarInvisible(){
    ...
    public void showLogoAndMakeProgressBarInvisible(){
        setAllProgressBarInvisible();
        mLogo.setVisibility(View.VISIBLE);
        mLogo2.setVisibility(View.VISIBLE);
        mLogo3.setVisibility(View.VISIBLE);
    }

    public void setOnClickYelpLogo(){
        mLogo.setOnClickListener((View view) -> {Intent browserYelpWebpage= new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.yelp.com"));
            startActivity(browserYelpWebpage);});
        mLogo2.setOnClickListener((View view)->{Intent browserYelpWebpage= new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.yelp.com"));
        startActivity(browserYelpWebpage);});
        mLogo3.setOnClickListener((View view)->{Intent browserYelpWebpage= new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.yelp.com"));
            startActivity(browserYelpWebpage);});
    }
}
